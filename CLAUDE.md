...
> 주의: `docs/api-spec.md`, `docs/acceptance-criteria.md`는 현재 스텁 상태다 (`docs/product-plan.md`,
> `docs/data-model.md`, `docs/ws-protocol.md`는 채워짐). 해당 문서를 참조하는 feature(아래
> "세부 문서" 참고)를 시작하기 전에 반드시 실제 내용을 채워야 한다. 스텁인 채로 구현을 진행하지 않는다.
...
- `docs/ws-protocol.md` — 커스텀 Yjs WebSocket 프로토콜 (가장 상세) (작성됨)
- `docs/data-model.md` — Y.Map/Y.Array 데이터 스키마 (작성됨)
