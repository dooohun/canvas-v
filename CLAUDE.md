...
> 주의: `docs/product-plan.md`, `docs/api-spec.md`, `docs/ws-protocol.md`, `docs/data-model.md`,
> `docs/acceptance-criteria.md`는 현재 스텁 상태다. 해당 문서를 참조하는 feature(아래 "세부 문서"
...
- `docs/product-plan.md` — 전체 기획안 (목적, 사용자 시나리오, 화면 구성, 범위 조정 옵션) — **스텁**
